Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'the properties that will be implemented when the program starts
        Me.Height = 370

        'initailly allthe nputs are blank
        ...
        'all the labels and text boxes are not visible initailly as they are not required
        info.Visible = False
        info2.Visible = False
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        ...
        ' when the user clears we have to exit all processes
        ' so the value of flag and check are changed accordingly
        ...
        ' again all the labels and text boxes arre made invisible
        flag = -1
        check = -1
        info.Visible = False
        info2.Visible = False
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnSolve.Click
        ...
        'finding out the value of the precision
        ...
        'we try to convert the integer into decimal format
        If Decimal.TryParse(input_a.Text, test1) And Decimal.TryParse(input_b.Text, test2) And Decimal.TryParse(input_c.Text, test3) Then
            Try
                ...
                Timer1.Start()
                'if a=0 we get a linear equation
                If a = 0 Then
                ...
                Else
                    ...
                    'to display the nature of roots, we make the label visible
                    info.Visible = True
    ...
    Private Sub input_a_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles input_a.Validating
        ...
        'the funtion checks if text box a is correct
    ...
    Private Sub input_b_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles input_b.Validating
        ...
        ErrorProvider3.SetError(input_b, "")
        'the funtion checks if text box b is correct
    ...
    Private Sub input_c_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles input_c.Validating
        ...
        Dim test As Decimal
        'the funtion checks if text box c is correct
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        'at each timer we check if we have to print the txt_root
        If flag = 0 Then
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        ctr2 += 1
        'at each timer check the value of the check variable
    ...
    Private Sub see_again_Click(sender As Object, e As EventArgs) Handles see_again.Click
        'the funtion to implement the button again has been implemented here
    ...
    Private Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        ...
        'if the user presses button next we move ont o the next step
    ...
    Private Sub btnPrev_Click(sender As Object, e As EventArgs) Handles btnPrev.Click
        'if the user presses button previous we move onto the previous step
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ' to add the graph we use the chart utility of the toolbox
        Chart1.Series.Clear()
